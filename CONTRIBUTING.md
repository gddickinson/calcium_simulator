# Contributing to calcium_simulator
...
[GitHub issue](https://github.com/gddickinson/calcium_simulator/issues) rather than emailing —
...
2. **What happened** versus what you expected. Paste the full traceback if there
   was one.
3. **Your data** — the model parameters used and the behaviour you expected to see.
